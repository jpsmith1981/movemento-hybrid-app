...
pipeline = [
  ...
  "src/coffee/directives.js/api/utils/*"
  "src/coffee/directives.js/api/managers/*"

  "src/coffee/controllers/polyline-display"
  "src/coffee/utils/*"

  "src/coffee/directives.js/api/options/**/*"
  "src/coffee/directives.js/api/models/child/*"
  "src/coffee/directives.js/api/models/parent/*"
  "src/coffee/directives.js/api/*"
  "src/coffee/directives.js/map"
  "src/coffee/directives.js/marker"
  "src/coffee/directives.js/markers"
  "src/coffee/directives.js/label"
  "src/coffee/directives.js/polygon"
  "src/coffee/directives.js/circle"
  "src/coffee/directives.js/polyline*"
  "src/coffee/directives.js/rectangle"
  "src/coffee/directives.js/window"
  "src/coffee/directives.js/windows"
  "src/coffee/directives.js/layer"
  "src/coffee/directives.js/control"
  "src/coffee/directives.js/*"
]
    ...
    coffee:
      ...
      specs:
        ...
        #specs
          ...
          "spec/coffee/directives.js/api/*.coffee"
          "spec/coffee/providers/*.coffee"
          "spec/coffee/directives.js/api/models/child/*.coffee"
          "spec/coffee/directives.js/api/models/parent/*.coffee"
          "spec/coffee/directives.js/api/options/**/*.coffee"
          "spec/coffee/directives.js/api/utils/*.coffee"
        ]
        dest: "tmp/"
        ext: '.spec.js'
